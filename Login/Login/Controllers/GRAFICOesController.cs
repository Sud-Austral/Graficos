...
namespace Login.Controllers
{
    public class GRAFICOesController : Controller
    {
        ...
        {
            var gRAFICO = db.GRAFICO.Include(g => g.CATEGORIA).Include(g => g.DETALLE).Include(g => g.FUENTE).Include(g => g.PARAMETRO).Include(g => g.TEMPORALIDAD).Include(g => g.TERRITORIO).Include(g => g.TIPO_GRAFICO);
        ...
        public ActionResult Create([Bind(Include = "id,nombre,descripcion,titulo,subtitulo,tags,url,iso_pais,nivel_administrativo,descripcion_larga,fecha_publicacion,idioma,responsable,shopify,auxiliar,rango_edad,CATEGORIA_id,PARAMETRO_id,DETALLE_id,TERRITORIO_id,TEMPORALIDAD_id,TIPO_GRAFICO_id,FUENTE_id,unidad_medida,tamanio_muestra,caracteristica_especial,auxiliar_1")] GRAFICO gRAFICO)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,descripcion,titulo,subtitulo,tags,url,iso_pais,nivel_administrativo,descripcion_larga,fecha_publicacion,idioma,responsable,shopify,auxiliar,rango_edad,CATEGORIA_id,PARAMETRO_id,DETALLE_id,TERRITORIO_id,TEMPORALIDAD_id,TIPO_GRAFICO_id,FUENTE_id,unidad_medida,tamanio_muestra,caracteristica_especial,auxiliar_1")] GRAFICO gRAFICO)
        {
            if (ModelState.IsValid)
            {
